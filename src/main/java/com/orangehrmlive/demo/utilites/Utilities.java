package com.orangehrmlive.demo.utilites;

import com.orangehrmlive.demo.drivermanager.DriverManager;
...
public class Utilities extends DriverManager {
    ...
    public void alertPopUpWindowAndVerifyText(String expResult){
